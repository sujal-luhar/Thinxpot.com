  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        class="flex font-medium items-center justify-center mt-8 mb-4"
      >
        <section
          className="w-[900px] flex-row flex mx-auto rounded-2xl px-8 py-6 bg-[#0b1b2c] shadow-lg"
          style={{ backgroundColor: isFollowing ? "#0b1b2c" : "#152a41" }}
        >
