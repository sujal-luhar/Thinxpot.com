          ...
          <div className="w-full">
            ...
            <div className="flex items-center">
              <div className="flex-1 text-center">
                <a href="#" className="w-12 mt-1 group flex items-center text-gray-700 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-900 hover:text-gray-300">
